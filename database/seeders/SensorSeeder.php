...
class SensorSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $sensors = [
            ...
            [
                'pid' => 'TL_C_SPD',
                'name' => 'Total Fuel Consumed (Speed)',
                'description' => 'Total acumulado de combustible consumido según estimación por velocidad',
                'category' => 'fuel',
                'unit' => 'L',
                'data_type' => 'numeric',
                'min_value' => 0,
            ...
            [
                'pid' => 'gps_sats',
                'name' => 'GPS Satellites',
                'description' => 'Número de satélites visibles por el receptor GPS',
                'category' => 'gps',
                'unit' => 'count',
                'data_type' => 'integer',
                'min_value' => 0,
            ...
            [
                'pid' => 'acc_x',
                'name' => 'Acceleration X',
                'description' => 'Aceleración eje X (sensor inercial)',
                'category' => 'imu',
                'unit' => 'm/s²',
                'data_type' => 'numeric',
                'min_value' => -50,
            ...
            [
                'pid' => 'acc_y',
                'name' => 'Acceleration Y',
                'description' => 'Aceleración eje Y (sensor inercial)',
                'category' => 'imu',
                'unit' => 'm/s²',
                'data_type' => 'numeric',
                'min_value' => -50,
            ...
            [
                'pid' => 'acc_z',
                'name' => 'Acceleration Z',
                'description' => 'Aceleración eje Z (sensor inercial)',
                'category' => 'imu',
                'unit' => 'm/s²',
                'data_type' => 'numeric',
                'min_value' => -50,
            ...
            [
                'pid' => 'gyro_x',
                'name' => 'Gyroscope X',
                'description' => 'Velocidad angular eje X (giroscopio)',
                'category' => 'imu',
                'unit' => '°/s',
                'data_type' => 'numeric',
                'min_value' => -2000,
            ...
            [
                'pid' => 'gyro_y',
                'name' => 'Gyroscope Y',
                'description' => 'Velocidad angular eje Y (giroscopio)',
                'category' => 'imu',
                'unit' => '°/s',
                'data_type' => 'numeric',
                'min_value' => -2000,
            ...
            [
                'pid' => 'gyro_z',
                'name' => 'Gyroscope Z',
                'description' => 'Velocidad angular eje Z (giroscopio)',
                'category' => 'imu',
                'unit' => '°/s',
                'data_type' => 'numeric',
                'min_value' => -2000,
            ...
            [
                'pid' => 'FC',
                'name' => 'Fuel Consumption',
                'description' => 'Consumo de combustible total (método seleccionado)',
                'category' => 'fuel',
                'unit' => 'L/100km',
                'data_type' => 'numeric',
                'min_value' => 0,
            ...
            [
                'pid' => 'FC_MAF',
                'name' => 'Fuel Consumption (MAF)',
                'description' => 'Consumo de combustible estimado a partir de MAF',
                'category' => 'fuel',
                'unit' => 'L/100km',
                'data_type' => 'numeric',
                'min_value' => 0,
            ...
            [
                'pid' => 'TL_C_MAF',
                'name' => 'Total Fuel Consumed (MAF)',
                'description' => 'Total acumulado de combustible consumido calculado a partir del flujo de aire MAF',
                'category' => 'fuel',
                'unit' => 'L',
                'data_type' => 'numeric',
                'min_value' => 0,
            ...
            [
                'pid' => 'FC_MAP',
                'name' => 'Fuel Consumption (MAP)',
                'description' => 'Consumo de combustible estimado a partir de MAP',
                'category' => 'fuel',
                'unit' => 'L/100km',
                'data_type' => 'numeric',
                'min_value' => 0,
            ...
            [
                'pid' => 'TL_C_MAP',
                'name' => 'Total Fuel Consumed (MAP)',
                'description' => 'Total acumulado de combustible consumido estimado por método MAP',
                'category' => 'fuel',
                'unit' => 'L',
                'data_type' => 'numeric',
                'min_value' => 0,
            ...
            [
                ...
                'description' => 'Consumo de combustible estimado en base a velocidad',
                'category' => 'fuel',
                'unit' => 'L/100km',
                'data_type' => 'numeric',
                'min_value' => 0,
